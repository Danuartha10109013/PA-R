...
<body>
    <div class="email-wrapper">
        ...
        <div class="email-body @if ($isCEO) priority-ceo @endif">
            ...
            <p>Task <strong>{{ $task->title }}</strong> akan mencapai deadline:</p>
            ...
            <div class="project-card">
                ...
                <div class="project-detail">
                    <i>📅</i>
                    <span>Deadline: <span class="highlight">{{$task->due_date}}</span></span>
                </div>
                <div class="project-detail">
                    <i>⏳</i>
                    <span>Status: <span
                            class="highlight">{{ ucfirst(str_replace('_', ' ', $task->status)) }}</span></span>
                </div>
                @if ($isCEO)
                    {{-- <div class="project-detail">
                        <i>👥</i>
                        <span>Total Anggota Tim: <span class="highlight">{{ $task->members->count() }}</span></span>
                    </div> --}}
                    <div class="project-detail">
                        <i>👤</i>
                        <span>Pemimpin Task: <span class="highlight">{{ $user->name }}</span></span>
                    </div>
                @endif
            </div>

            <p>Segera tinjau dan pastikan Task ini selesai tepat waktu!</p>
